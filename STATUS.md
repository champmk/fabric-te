...
Repo name: **fabric-te**  
Phase: PR8 implemented. **Next: PR9.**

**Next:** PR9 — failure + 2PC.
...
`docs/DESIGN.md` §14, §30 PR9.

No in-place graph mutation. Prepare returns `{graph',kills,reroutes,residual'}`. Planner is PR10.
